...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["section_list"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $setup.activity['terms_and_conditions_' + $setup.lang] && $setup.activity['terms_and_conditions_' + $setup.lang] != 'null' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["ListSection"], {
    key: 9,
    "class": "border py-2 mt-3",
    section_list: $setup.activity['terms_and_conditions_' + $setup.lang],
