        ...
        >
          <div class="flex items-center">
            <svg
              ...
              class="h-6 text-gray-600 hover:text-black cursor-pointer me-3"
              viewBox="0 0 20 20"
              fill="currentColor"
              @click="showMenu(-1)"
            >
      ...
      >
        <div class="flex" id="menu">
          ...
          >
            ...
            >
              <li
                class="w-full flex justify-between md:w-auto"
          ...
          >
            <li
              ...
              @click="
                item['items'].length > 0
                  ? setSubmenu(i)
                  : (router.push({ path: `/${item.slug}` }), closeMenu())
              "
            >
              <button
          ...
          >
            <li
              ...
              @click="
                item['items'].length > 0
                  ? setSubSubMenu(j)
                  : (router.push({ path: `/${menu_slug}/${item.slug}` }),
                    closeMenu())
              "
            >
              <button
