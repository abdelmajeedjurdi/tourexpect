        ...
        ">
          ...
          ">
                    ...
                    <ul class="flex flex-col py-4 space-y-1 -ml-6">
                        ...
                        <li>
                            <router-link :to="{ name: 'categories.index' }" class="
                                relative
                                flex flex-row
                                items-center
                                h-11
                        ...
                        <li>
                            <router-link :to="{ name: 'packages.index' }" class="
                                                            relative
                                                        flex flex-row
                                                        items-center
                                                        h-11
                        ...
                        <li>
                            <router-link :to="{ name: 'hotels.index' }" class="
                                                            relative
                                                        flex flex-row
                                                        items-center
                                                        h-11
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">Hotels And Resorts</span>
                            </router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <router-link :to="{ name: 'options' }" class="
                                                            relative
                                                        flex flex-row
                                                        items-center
                                                        h-11
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">Option</span>
                            </router-link>
                        </li>
                    </ul>
                </div>
            ...
            <!-- ./Sidebar -->
            <div class="min-h-screen ml-10 dark:bg-gray-700 dark:text-gray-400 p-6">
                <router-view />
            </div>
        </div>
    </div>
