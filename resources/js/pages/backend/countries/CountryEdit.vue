            ...
            <div class="space-y-4 rounded-md w-full">
                    ...
                    <div class="w-full me-2">
                        ...
                        <div class="mt-1">
                            <textarea
                                ...
                                id="description_en"
                                class="block mt-1 w-full rounded-md border-gray-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800"
                                v-model="country.description_en"
                            />
                        </div>
                    </div>
                    <div class="w-full">
                        ...
                        <div class="mt-1">
                            <textarea
                                ...
                                id="description_ar"
                                class="block mt-1 w-full rounded-md border-gray-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-800"
                                v-model="country.description_ar"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div
                        ...
                        v-if="country.image != undefined"
                    >
                        <img
                            :src="
                                imagePreview != null
                                    ? imagePreview
                                    : '/images/countries/' + country.image
                            "
                            alt=""
...
const { errors, country, getCountry, updateCountry, countries, getCountries } =
    useDestinations();
let Swal = useSwal();
...
const saveCountry = async () => {
    await updateCountry(props.id, { form: country.value, file });
};
