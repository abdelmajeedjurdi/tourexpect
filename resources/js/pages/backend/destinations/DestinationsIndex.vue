                ...
                <div class="bg-white rounded-lg overflow-hidden mb-10">
                    ...
                    >
                        ...
                        <div class="p-2 h-32">
                            ...
                            >
                                {{
                                    destination.description_en.substring(
                                        0,
                                        100
                                    ) +
...
const { destinations, getDestinations, destroyDestination, pages, duplicate } =
    useDestinations();
