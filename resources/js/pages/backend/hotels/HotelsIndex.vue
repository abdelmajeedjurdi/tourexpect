<template>
    <div class="w-full">
        <div class="mx-2 flex justify-between place-content-end mb-4">
            ...
            <router-link :to="{ name: 'hotel.create' }" class="
                px-4
                py-2
                bg-blue-600
                hover:bg-blue-700
                cursor-pointer
                rounded-lg text-sm font-medium text-white">New Hotel
            </router-link>
        </div>
      ...
      ">
            <div v-for="hotel in hotels" :key="hotel.id">
                <div class="bg-white rounded-lg overflow-hidden mb-10">
                    ...
                    <router-link :to="{ name: 'hotel.details', params: { id: hotel.id } }">
                        <img :src="'/images/hotels/' + hotel.thumbnail" :alt="hotel.title_en + ' image'"
...
const { hotels, getHotels, destroyHotel, pages, dublicate } = useHotels();
