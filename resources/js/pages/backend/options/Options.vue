        ...
        <div class="flex">
            ...
            <div class="  w-1/2">
                <form @submit.prevent="updateIcons">
                    ...
                    <h2>Options Icons</h2>
                    <UploadImages @changed="handleImages" uploadMsg="Drop Icons Here or Click to Add Icons." />
                    <div>
                        <p>
                            ...
                            <div v-for="image in icons" :key="image.id">
                                <div class="bg-gray-100 rounded-lg overflow-hidden mb-12 ">
                                    <div class="w-full flex justify-end z-20">
                                        <span class="rounded-full transition-all duration-300 absolute">
                                    ...
                                    <div>
                                        <img :src="'/images/icons/' + image.image"
