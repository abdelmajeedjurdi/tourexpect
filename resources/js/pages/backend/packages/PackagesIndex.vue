<template>
    <div class="w-full">
        <div class="mx-2 flex justify-between place-content-end mb-4">
            ...
            <router-link :to="{ name: 'single_package.create' }" class="
                px-4
                py-2
                bg-blue-600
                hover:bg-blue-700
                cursor-pointer
                rounded-lg text-sm font-medium text-white">New Package
            </router-link>
        </div>
      ...
      ">
            <div v-for="single_package in packages" :key="single_package.id">
                <div class="bg-white rounded-lg overflow-hidden mb-10">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="w-full hover:bg-gray-300">
                                        <router-link style="padding-right: 70%" class="w-full ms-2" :to="{
                                            ...
                                            params: { id: single_package.id },
                                        }">Edit
                                        </router-link>
                                    </li>
                                    <li @click="deleteRow(single_package)"
                                        class="ps-2 w-full text-red-500 hover:bg-gray-300 cursor-pointer">

                                        Delete
                                    </li>
                                    <li @click="dublicateRow(single_package.id)"
                    ...
                    <router-link :to="{ name: 'single_package.details', params: { id: single_package.id } }">
                        <img :src="'/images/packages/' + single_package.thumbnail"
                            :alt="single_package.title_en + ' image'" class="w-full h-48 object-cover" />
                        <div class="p-2 h-32">
                            ...
                            <p class="
                                ...
                                ">
                                {{
                                single_package.description_en.substring(0, 100) +
...
const { packages, getPackages, destroyPackage, pages, dublicate } = usePackages();
