<template>
    <div class="sm:px-4 xl:px-0 sm:flex w-full max-w-6xl mx-auto my-28">
        ...
        <div class="w-full px-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="p-2 h-36">
                                ...
                                >
                                    {{
                                        blog["preview_text_" + lang].substring(
                                            0,
                                            100
                                        ) +
                                        (blog["preview_text_" + lang].length >
                                        100
                                            ? "..."
                                            : "")
                                    }}
            ...
            <div
                v-if="pagenation['meta'] !== undefined"
                class="w-full text-center"
            >
                <nav aria-label="Page navigation example">
                    <ul class="inline-flex items-center -space-x-px">
                        <li
                            v-if="pagenation['meta']['current_page'] != 1"
                            @click="
                                filter.page =
                                    pagenation['meta']['current_page'] - 1
                            "
                        ...
                        <li
                            v-for="link in pagenation['meta']['links']"
                            :key="link"
                        ...
                        <li
                            v-if="
                                pagenation['meta']['current_page'] !=
                                pagenation['meta']['last_page']
                            "
                            @click="
                                filter.page =
                                    pagenation['meta']['current_page'] + 1
